...
def main():
    ...
    for r in read("entity_names.csv"): names[r["entity_id"]].append(r)
    roster = defaultdict(list)
    for r in read("legal_roster_2000_2024.csv"): roster[r["entity_id"]].append(r)
