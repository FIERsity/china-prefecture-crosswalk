...
- 单个名称、年份和省份查询；
- 1983—2026 市级、地区级和盟级行政区划事件检索，1983—2026 县级变更记录；
- 机器可读数据下载。
...
当前网页数据还包含 V3.3 市级事件层：保留原有 144 条结构化地级事件，另从 1983—1986 年早期材料中抽取 67 条市级、地区级和盟级变化，合计 211 条。事件查询窗口为 1983—2026，现有市级事件记录到 2018 年；早期记录保留原文、版次或页面定位和来源 ID，主要来源为人民日报历史版面及区划地名网根据国务院批复整理的转录。这些记录用于事件检索和城市卡片展示，年度状态表仍从1987年开始。县级补充层共 1,435 条，韩城县改韩城市等县改县级市事件已纳入。县级记录只做描述性展示和宽松地级关联，不宣称完成严格的县级谱系重建。
...
| 统一地级变更事件 | 144 |
| 市级/地区级事件层 | 211 条（查询窗口 1983—2026，现有记录到 2018），其中 67 条来自早期材料 |
| 事件关系 | 149 |
| 维基地级原始记录 | 988 |
| 连续性审计 | 1,285 项，0 错误 |
...
| [`prefecture_administrative_events_1983_2026.csv`](data/processed/prefecture_administrative_events_1983_2026.csv) | 1983—2026 市级、地区级和盟级事件层 |
