...
| Taiwan names | `taiwan_geoboundaries/tw_area.json`, `tw_area_position.json` | [xue-yuan/tw-area-json](https://github.com/xue-yuan/tw-area-json) | MIT-licensed Traditional-Chinese township/district names and centroids; converted to Simplified Chinese and matched to ADM2 geometry by nearest centroid. |
